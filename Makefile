...
#    Updated: 2024/05/31 11:14:40 by ksainte          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

CC = gcc -g3
CFLAGS = -Wall -Wextra -Werror
SRCS = src/main.c src/color.c src/hooks.c src/window.c src/image.c src/open.c src/get_next_line.c src/get_next_line_utils.c src/utils.c src/paste.c
LIBFT_PATH = Libft
MLX_PATH = mlx
