...
#    Updated: 2024/05/28 11:29:49 by ksainte          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

CC = gcc -g3
CFLAGS = -Wall -Wextra -Werror
SRCS = src/main.c src/color.c src/hooks.c src/window.c src/image.c src/open.c src/get_next_line.c src/get_next_line_utils.c src/utils.c
LIBFT_PATH = Libft
MLX_PATH = mlx
